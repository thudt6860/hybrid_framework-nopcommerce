...
public class MethodListener implements IInvokedMethodListener { // MethodListener nhiệm vụ tạo ra các log. nếu có nhiều hơn 1 điểm lỗi thì phải show all hết lỗi
	@Override
