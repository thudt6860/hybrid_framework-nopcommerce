...
public class Framwork_Bai25_ExtentV5 extends BaseTest {
	// Khai báo
	...
	public void User_01_Register(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 04: Enter to Email Address textbox with value is '" + emailAddress + "'");
	...
	public void User_02_Login(Method method) {
		...
		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 02: Enter to Email textbox with value is '" + emailAddress + "'");
		loginPage.inputToEmailTextbox(emailAddress);

		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 03: Enter to Password textbox with value is '" + validPassword + "'");
		loginPage.inputToPasswordTextbox(validPassword);

		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 04: Click to Login button");
		homePage = loginPage.clickToLoginButton();

		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 05: Verify 'My Account' link is displayed");
		Assert.assertFalse(homePage.isMyAccountLinkDisplayed());

		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 06: Navigate to 'My Account' page");
		customerInfoPage = homePage.openMyAccountPage();

		ExtentTestManagerV5.getTest().log(Status.INFO, "Register - Step 07: Verify Customer Infor page is displayed");
