...
public class Framwork_Bai24_ExtentV2_Screenshot extends BaseTest {
	...
	public void User_02_Login(Method method) {
		...
		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 02: Enter to Email textbox with value is '" + emailAddress + "'");
		loginPage.inputToEmailTextbox(emailAddress);

		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 03: Enter to Password textbox with value is '" + validPassword + "'");
		loginPage.inputToPasswordTextbox(validPassword);

		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 04: Click to Login button");
		homePage = loginPage.clickToLoginButton();

		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 05: Verify 'My Account' link is displayed");
		Assert.assertFalse(homePage.isMyAccountLinkDisplayed());

		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 06: Navigate to 'My Account' page");
		customerInfoPage = homePage.openMyAccountPage();

		ExtentTestManager.getTest().log(LogStatus.INFO, "Register - Step 07: Verify Customer Infor page is displayed");
